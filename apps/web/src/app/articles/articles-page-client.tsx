    ...
    <div className="min-h-screen bg-[#0A0A0A] text-white">
      <main className="pt-40 pb-20">
        <div className="container mx-auto px-6">
          ...
          <PageTitleHeader
            title="ARTICLES"
            description="Explore stories, interviews, and deep dives into Arkansas music"
          />
          ...
          <div className="space-y-16">
            {categoryOrder.map((category) => {
              ...
              const categoryHref = categoryRouteMap[category] ?? "/articles";
                ...
                <section key={category} className="animate-fadeInUp">
                  <div className="flex items-center justify-between mb-8">
                    <div className="flex items-center">
                      ...
                      <div className="ml-6 h-1 bg-[#7CFC00] grow" style={{ maxWidth: "200px" }} />
                    </div>
                    <Link
                      href={categoryHref}
