  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "fixed z-10 hidden w-(--sidebar-width) top-[var(--sidebar-offset-top)] bottom-auto h-[calc(100svh-var(--sidebar-offset-top))] transition-[left,right,width] duration-200 ease-linear md:flex",
          side === "left"
