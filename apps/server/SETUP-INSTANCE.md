...
```bash
ssh -i ~/Downloads/deadparty-server-2.pem bitnami@18.224.61.135
```

If connection fails, check:
- SSH key permissions: `chmod 600 ~/Downloads/deadparty-server-2.pem`
...
- Check key permissions: `chmod 600 ~/Downloads/deadparty-server-2.pem`
